        ...
        <>
            <footer className='mt-80 bg-[#141516] flex flex-col gap-10 p-6'>
                <div className='flex gap-2 flex-col'>
                    ...
                    <p className='text-[#a1a1a2] text-lg'>Raising lives, building faith, transforming destinies through Christ.</p>
                ...
                <div className='flex flex-col gap-8'>
                    ...
                    <div className='flex justify-center items-center p-4'>
                        <p className='text-[#a1a1a2] text-sm'>Designed and inspired by Josephine</p>
                    </div>
                </div>
            </footer>
        </>
